...
export default function Market() {
  ...
  function renderClosedBanner() {
    ...
    if (display.isEmptyExpired) {
      return (
        <div className="card" style={{ textAlign: "center", padding: 24, borderColor: "var(--border)" }}>
          <p style={{ color: "var(--text3)", fontSize: 14 }}>This market expired with no bets placed.</p>
        </div>
      );
    }
