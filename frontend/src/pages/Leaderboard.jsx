        ...
        {[
          ...
          <div key={s.label} className="card" style={{ textAlign: "center", position: "relative", overflow: "hidden" }}>
            <img src={s.img} alt="" onError={e => e.currentTarget.style.display = "none"}
              style={{ position: "absolute", bottom: 0, right: 0, width: 90, height: 64, objectFit: "cover", objectPosition: "top", opacity: 0.12, borderTopLeftRadius: 8, pointerEvents: "none" }}
            />
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ fontFamily: "var(--font-display)", fontSize: 28, color: "var(--silver)", letterSpacing: "0.04em" }}>{s.value}</div>
      ...
      {!loading && sorted.length === 0 && (
        <div className="card" style={{ textAlign: "center", padding: 48 }}>
          <p style={{ color: "var(--text3)" }}>
            {filter === "Live" ? "No live markets right now." : "No closed markets yet."}
          </p>
        </div>
      )}
